...
vmin=-1; vmax=1
genes = [ #mouse
    ("Ddx3x", 13280970, 13294052),
    ("Kdm6a", 18162575, 18279936),
    ("Eif2s3x", 94188709, 94212651),
    ("Xist", 103460373, 103483233),
    ("Pbdc1", 105079756, 105117090),
    ("Kdm5c", 152233020, 152274535),
    ("Mid1", 169685199, 169990798),
    ("Car5b", 163976822, 164027997)
]
